...
interface LinkHostProps {
  host: AdcmHostDuplicate;
}

const UnlinkHostDuplicateToggleButton: React.FC<LinkHostProps> = ({ host }) => {
  ...
  return <IconButton icon={linkIcons[linkMode]} size={32} title={firstUpperCase(linkMode)} onClick={handleLinkClick} />;
};

export default UnlinkHostDuplicateToggleButton;

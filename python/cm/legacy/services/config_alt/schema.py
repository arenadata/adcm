...
from cm.legacy.services.config_alt import repo
from cm.legacy.services.config_alt._common import is_editable
from cm.legacy.services.config_alt._variant import resolve_variant
from cm.legacy.services.config_alt.types import (
    ConfigOwner,

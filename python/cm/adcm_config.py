...
def check_value_unselected_field(
    ...
    def check_empty_values(spec_type: str, key: str, current: dict, new: dict) -> bool:
    ...
    def check_structure(checked_config: dict) -> bool:

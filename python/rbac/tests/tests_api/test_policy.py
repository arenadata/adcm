...
def test_create_policy(admin_api_client):
    ...
    data = [
        ...
        (
            {"name": "test", "role": {"id": 85}, "user": None},
            {
        ...
        (
            {"name": "test", "role": {"id": 85}, "user": "string"},
            {
        ...
        (
            {"name": "test", "role": {"id": 85}, "user": [{"id": None}]},
            {
        ...
        (
            {"name": "test", "role": {"id": 85}, "user": [{"id": "string"}]},
            {
        ...
        (
            {"name": "test", "role": {"id": 85}, "user": [{"id": 1000}]},
            {
        ...
        (
            {"name": "test", "role": {"id": 85}, "user": [{"id": 2}], "object": None},
            {"object": ["This field may not be null."]},
        ),
        (
            {"name": "test", "role": {"id": 85}, "user": [{"id": 2}], "object": 1},
            {"object": ["the field does not match the scheme"]},
        ),
        (
            {"name": "test", "role": {"id": 85}, "user": [{"id": 2}], "object": "string"},
            {"object": ["the field does not match the scheme"]},
        ),
        (
            {"name": "test", "role": {"id": 85}, "user": [{"id": 2}], "object": {}},
            {"object": ["the field does not match the scheme"]},
        ),
        (
            {"name": "test", "role": {"id": 85}, "user": [{"id": 2}], "object": [1]},
        ...
        (
            {"name": "test", "role": {"id": 85}, "user": [{"id": 2}], "object": [{"id": 1}]},
            {"object": ["the field does not match the scheme"]},
        ),
    ]

    ...
    def test_policy_with_cluster_admin_role(self):
        ...
        self.assertEqual(
            required_perms,
            {
                ...
                "change_config_of_service",
                "change_config_of_host",
                "change_config_of_component",
                "change_configlog",
                "change_confighostgroup",
                "change_import_of_cluster",
                "change_import_of_service",
                "change_maintenance_mode_service",
                "change_maintenance_mode_host",
                "change_maintenance_mode_component",
                "change_objectconfig",
                ...
                "view_import_of_service",
                "view_objectconfig",
                "view_component",
                "view_upgrade_of_cluster",
                "view_ansible_config_of_cluster",
                "view_action_host_group_cluster",
                "view_action_host_group_service",
                "view_action_host_group_component",
                "edit_action_host_group_cluster",
                "edit_action_host_group_service",
                "edit_action_host_group_component",
                "view_logstorage",
                "view_joblog",
                "view_tasklog",
            },

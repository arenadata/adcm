...
@pytest.mark.skip('run as needed to check if performance remains the same')
@pytest.mark.django_db
def test_build_tree_performance():
    """
...
@pytest.mark.django_db
def test_get_directly_affected():
    ...
    for target_object, affected_objects in expected.items():
        ...
        assert expected_affected == got_affected


@pytest.mark.django_db
def test_get_all_affected():

                ...
                path(
                    ...
                    include(
                        [
                            ...
                            path(
                                'action/',
                                views.ServiceProtoActionList.as_view(),
    ...
    path(
        ...
        include(
            [
                ...
                path(
                    PROTOTYPE_ID, views.ComponentTypeDetail.as_view(), name='component-type-details'
                ),
            ]
        ),
    ),
    path(
        ...
        include(
            [
                ...
                path(
                    PROTOTYPE_ID, views.ProviderTypeDetail.as_view(), name='provider-type-details'
                ),
            ]
        ),
    ),

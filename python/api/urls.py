...
urlpatterns = [
    ...
    path(
        ...
        views.ConfigHistoryVersionView.as_view(),
        {'object_type': 'host'},
        name='host-config-history-version'
    ),
    path(
        HOST_CONFIG + 'history/<int:version>/restore/',
        views.ConfigHistoryRestoreView.as_view(),
        {'object_type': 'host'},
        name='host-config-history-version-restore'
    ),
    path(

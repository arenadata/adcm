...
urlpatterns = [
    ...
    path('profile/<name:username>/password/', views.UserPasswd.as_view(), name='profile-passwd'),
    ...
    path('stack/load/servicemap/', stack_views.LoadServiceMap.as_view(), name='load-servicemap'),
    path('stack/bundle/', stack_views.BundleList.as_view(), name='bundle'),
    path(
        'stack/bundle/<int:bundle_id>/', stack_views.BundleDetail.as_view(), name='bundle-details'
    ),
    path(
    ...
    path(CLUSTER + HOST, cluster_views.ClusterHostDetail.as_view(), name='cluster-host-details'),
    path(CLUSTER + 'service/', cluster_views.ClusterServiceList.as_view(), name='cluster-service'),
    path(
        CLUSTER + HOST + 'action/',
    ...
    path(CLUSTER + 'status/', cluster_views.StatusList.as_view(), name='cluster-status'),
    path(
        CLUSTER + 'hostcomponent/', cluster_views.HostComponentList.as_view(), name='host-component'
    ),
    path(
    ...
    path(
        SERVICE_CONFIG, cluster_views.ClusterServiceConfig.as_view(), name='cluster-service-config'
    ),
    path(
    ...
    path(ADCM_CONFIG + 'history/', views.AdcmConfigHistory.as_view(), name='adcm-config-history'),
    path(
    ...
    path(HOST + 'action/<int:action_id>/', views.HostAction.as_view(), name='host-action-details'),
    path(HOST + 'action/<int:action_id>/run/', views.HostTask.as_view(), name='host-action-run'),
    path(HOST_CONFIG, views.HostConfig.as_view(), name='host-config'),
    path(HOST_CONFIG + 'history/', views.HostConfigHistory.as_view(), name='host-config-history'),
    path(
    ...
    path(
        'job/<int:job_id>/log/<int:log_id>/', job_views.LogStorageView.as_view(), name='log-storage'
    ),
    path(
        'job/<int:job_id>/log/<int:log_id>/download/',

...
class TestServicePrototypeAPI(BaseTestCase):
    ...
    def test_list_filter_name(self):
        response: Response = self.client.get(
            path=reverse(viewname="v1:service-prototype-list"), data={"name": "test_prototype_2"}
        )
    ...
    def test_list_filter_bundle_id(self):
        response: Response = self.client.get(
            path=reverse(viewname="v1:service-prototype-list"),
    ...
    def test_list_ordering_display_name(self):
        response: Response = self.client.get(
            path=reverse(viewname="v1:service-prototype-list"), data={"ordering": "display_name"}
        )
    ...
    def test_list_ordering_version_order(self):
        response: Response = self.client.get(
            path=reverse(viewname="v1:service-prototype-list"), data={"ordering": "version_order"}
        )
    ...
    def test_retrieve(self):
        response: Response = self.client.get(
            path=reverse(viewname="v1:service-prototype-detail", kwargs={"prototype_pk": self.prototype_2.pk}),
        )
    ...
    def test_action(self):
        response: Response = self.client.get(
            path=reverse(viewname="v1:service-prototype-actions", kwargs={"prototype_pk": self.prototype_1.pk}),
        )

...
def document_config_host_group_viewset(object_type: str):
    ...
    return extend_schema_view(
        ...
        create=extend_schema(
            operation_id=f"post{capitalized_type}ConfigGroup",
            summary=f"POST {object_type}'s config group",
        ...
        config_schema=extend_schema(
            operation_id=f"get{capitalized_type}ConfigGroupConfigSchema",
            summary=f"GET {object_type}'s config group's config schema",
            description=f"Get {object_type}'s config group's schema information.",

...
def assert_config_type(
    path, config_type, entities, is_required, is_default, sent_value_type
):
    """
...
def nr_wd_cv(sdk_client_ms: ADCMClient, request):
    return processing_data(
        sdk_client_ms, request, "not_required_with_default_sent_correct_value"
    )
...
def nr_wd_ev(sdk_client_ms: ADCMClient, request):
    return processing_data(
        sdk_client_ms, request, "not_required_with_default_sent_empty_value"
    )
...
def nr_wd_nv(sdk_client_ms: ADCMClient, request):
    return processing_data(
        sdk_client_ms, request, "not_required_with_default_sent_null_value"
    )
...
def nr_wod_ev(sdk_client_ms: ADCMClient, request):
    return processing_data(
        sdk_client_ms, request, "not_required_without_default_sent_empty_value"
    )
...
def nr_wod_nv(sdk_client_ms: ADCMClient, request):
    return processing_data(
        sdk_client_ms, request, "not_required_without_default_sent_null_value"
    )
...
def r_wd_cv(sdk_client_ms: ADCMClient, request):
    return processing_data(
        sdk_client_ms, request, "required_with_default_sent_correct_value"
    )
...
def r_wd_ev(sdk_client_ms: ADCMClient, request):
    return processing_data(
        sdk_client_ms, request, "required_with_default_sent_empty_value"
    )
...
def r_wd_nv(sdk_client_ms: ADCMClient, request):
    return processing_data(
        sdk_client_ms, request, "required_with_default_sent_null_value"
    )
...
def r_wod_ev(sdk_client_ms: ADCMClient, request):
    return processing_data(
        sdk_client_ms, request, "required_without_default_sent_empty_value"
    )
...
def r_wod_nv(sdk_client_ms: ADCMClient, request):
    return processing_data(
        sdk_client_ms, request, "required_without_default_sent_null_value"
    )

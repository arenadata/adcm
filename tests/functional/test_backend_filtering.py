...
@pytest.mark.parametrize(
    ...
    [
        pytest.param(
            pytest.lazy_fixture('cluster_bundles'),
        ...
        pytest.param(
            ...
            id="Prototype"),
        pytest.param(
            pytest.lazy_fixture('provider_bundles'),
        ...
        pytest.param(
            ...
            id="Bundle"),
        pytest.param(
            pytest.lazy_fixture('clusters'),
            ClusterList,
            id="Cluster"),
        pytest.param(
            pytest.lazy_fixture('hosts'),
            HostList,
            id="Host"),
        pytest.param(
            pytest.lazy_fixture('host_with_jobs'),
            TaskList,
            id="Task"),
        pytest.param(
            pytest.lazy_fixture('host_with_jobs'),
...
@pytest.mark.parametrize(
    ...
    [
        pytest.param(
            ...
            ClusterPrototype,
            ClusterPrototypeList,
            pytest.lazy_fixture('one_cluster_prototype_name_attr'),
            pytest.lazy_fixture('one_cluster_prototype_name_attr'),
        ...
        pytest.param(
            ...
            ClusterPrototype,
            ClusterPrototypeList,
            pytest.lazy_fixture('one_cluster_prototype_bundle_id_attr'),
            pytest.lazy_fixture('one_cluster_prototype_bundle_id_attr'),
        ...
        pytest.param(
            ...
            ProviderPrototype,
            ProviderPrototypeList,
            pytest.lazy_fixture('provider_bundle_id'),
            pytest.lazy_fixture('provider_bundle_id'),
        ...
        pytest.param(
            ...
            Cluster,
            ClusterList,
            pytest.lazy_fixture('one_cluster_name_attr'),
            pytest.lazy_fixture('one_cluster_prototype_id_attr'),
        ...
        pytest.param(
            pytest.lazy_fixture('providers'),
            Provider,
            ProviderList,
            pytest.lazy_fixture('one_provider_name_attr'),
            pytest.lazy_fixture('one_provider_prototype_id_attr'),
        ...
        pytest.param(
            ...
            Host,
            HostList,
            pytest.lazy_fixture('one_host_fqdn_attr'),
            pytest.lazy_fixture('one_host_prototype_id_attr'),
            id="Host Fqdn Filter"),
        pytest.param(
            pytest.lazy_fixture('hosts'),
            Host,
        ...
        pytest.param(
            ...
            Task,
            TaskList,
            pytest.lazy_fixture('task_action_id_attr'),
            pytest.lazy_fixture('task_action_id_attr'),
        ...
        pytest.param(
            ...
            Task,
            TaskList,
            pytest.lazy_fixture('task_status_attr'),
            pytest.lazy_fixture('task_status_attr'),
        ...
        pytest.param(
            ...
            Job,
            JobList,
            pytest.lazy_fixture('job_task_id_attr'),
            pytest.lazy_fixture('job_task_id_attr'),
...
#     [
#         pytest.param(
#             pytest.lazy_fixture('cluster_with_actions'),
#             id="Cluster"
#         ),
#         pytest.param(
#             pytest.lazy_fixture('service_with_actions'),
#             id="Service"
#         ),
#         pytest.param(
#             pytest.lazy_fixture('provider_with_actions'),
#             id="Provider"
#         ),
#         pytest.param(
#             pytest.lazy_fixture('host_with_actions'),
#             id="Host"
#         ),
#     ])

...
def test_check_cluster_list_page_with_cluster_creating(app_fs, login_to_adcm_over_api, bundle_archive):
...
def test_check_cluster_list_page_pagination(sdk_client_fs: ADCMClient, app_fs, login_to_adcm_over_api):

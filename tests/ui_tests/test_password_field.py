...
def test_password_noconfirm_false_required_false(sdk_client_fs: ADCMClient, app_fs, login_to_adcm_over_api):
...
def test_password_noconfirm_false_required_true(sdk_client_fs: ADCMClient, app_fs, login_to_adcm_over_api):
...
def test_password_noconfirm_true_required_false(sdk_client_fs: ADCMClient, app_fs, login_to_adcm_over_api):
...
def test_password_noconfirm_true_required_true(sdk_client_fs: ADCMClient, app_fs, login_to_adcm_over_api):

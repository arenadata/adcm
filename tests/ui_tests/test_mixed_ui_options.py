...
def _check_all_groups_and_fields_invisible(sdk_client: ADCMClient, path, app):
...
@parametrize_by_data_subdirs(
    __file__,
    "group_advanced_false_invisible_false_field_advanced_false_invisible_false",
)
...
def test_groups_false_fields_true(
    sdk_client_fs: ADCMClient, path, app_fs, login_to_adcm
):
    """Invisible and advanced for groups false for fields true"""
    _check_invisible_and_advanced_for_groups_false_for_fields_true(
...
def test_groups_true_fields_false(
    sdk_client_fs: ADCMClient, path, app_fs, login_to_adcm
):
    """Invisible and advanced for groups true for fields false.
    In this case no elements presented on page
